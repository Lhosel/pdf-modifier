...
import pdf from '../images/pdfs/certificate-of-participation.pdf';
...
export default function Participation() {
    ...
    const modifyPdf = async (e) => {
        ...
        download(pdfBytes, `${fullName}_${date}_participation.pdf`, "application/pdf");
    ...
    return (
        <div className="create-content">
            <h1 className="create-h1">Create Participation Certificate</h1>
